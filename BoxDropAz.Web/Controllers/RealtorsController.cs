...
public sealed class RealtorsController : Controller
{
    public IActionResult Index()
    {
        ...
        ViewData["Description"] = "Gift reusable moving totes to your closing clients. Monthly credit, co-branded delivery, and a claim link your client redeems on their own schedule.";
        return View();
    }
    ...
    public IActionResult Plans()
    {
        ...
        ViewData["Description"] = "Starter, Professional, and Brokerage plans for real estate agents gifting reusable moving totes at closing. Credit rolls over up to three months.";
